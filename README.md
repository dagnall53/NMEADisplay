...
The Code WILL accept serial NMEA0183 over USB - but is set default to 115200. It sends out debugging data on serial (at 115200 baud) if you have it connected to a PC with a suitable terminal program.   Make sure the module (back) looks like this..
